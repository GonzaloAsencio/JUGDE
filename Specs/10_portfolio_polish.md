...
```markdown
## ADR-001: Why LlamaIndex over LangChain

**Decision:** Use LlamaIndex for RAG orchestration.

**Context:** Both LlamaIndex and LangChain support RAG. LlamaIndex has 
better default behavior for retrieval, less abstraction overhead, and 
cleaner APIs for the patterns I needed.
...
**ADRs sugeridos:**
- ADR-001: LlamaIndex vs LangChain
...
Tech: LlamaIndex, FastAPI, Next.js, pgvector, Gemini Flash, RAGAS
